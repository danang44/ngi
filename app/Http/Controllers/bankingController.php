...
class bankingController extends Controller
{
    ...
    public function index()
    {
        ...
        $banking = banking::latest()->paginate(5);
        return view('banking.banking', compact('banking'));
    }
    ...
    {
        return view('banking.create-banking');
    }
    ...
    {
        $banking = new banking;
        $banking->judul = $request->input('judul');
        $banking->tanggal = $request->input('tanggal');

        $banking->kategori = $request->input('kategori');
        $banking->deskripsi = $request->input('deskripsi');
        $banking->kontenlengkap = $request->input('kontenlengkap');
        ...
        if ($request->hasfile('gambar')) {
            ...
            $banking->gambar = $filename;
        }
        $banking->save();
        return redirect('banking')->with('toast_success', 'Data Berhasil Disimpan!');
    }
