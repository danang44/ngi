        ...
        <div class="card-body">
            <form action="{{url('ubah-header',$header->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Judul</label>
                    <input type="text" id="judul" name="judul" class="form-control" value=" {{$subheader->judul }} ">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="subjudul" name="subjudul" class="form-control" value="{{$sub    header->subjudul}}">
                </div>
