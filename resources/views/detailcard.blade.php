...
<head>
    ...
    <link href="/ne/css/style-portofolio.css" rel="stylesheet">
  ...
  -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:ital,wght@0,400;0,500;0,600;0,700;1,600&family=Manrope:wght@200&family=Playfair+Display:ital,wght@1,400;1,500;1,600&display=swap" rel="stylesheet">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <h1>{{$item->judul}}</h1>
                <a href="{{route('contact-detail')}}" class="btn-hero">Get In Touch</a>
            </div>
        </div>
    </div>
</section>
...
<!--Video Play-->
<div class="col-lg-12">
    <img class="img-assets" src="{{asset('img/'.$item->gambar)}}" alt="">
</div>
<article>

    <div class="date-share text-muted fst-italic d-flex justify-content-lg-between">
        <div class="d-flex">
            <p>Tanggal Posting</p>
            <p>&nbsp;.&nbsp;</p>
    ...
    <!-- Post content-->
    <section class="mb-5 j-s">
        <p class="fs-5 mb-4">{!!$item->kontenlengkap!!}</p>
...
<script src="/ne/js/main-portofolio.js"></script>
