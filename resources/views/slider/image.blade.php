...
<div class="container-fluid">
        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="card-tools">
                    ...
                    &nbsp;
                    <a href="{{route('trash-image')}}" class="btn btn-danger">Trash <i class="fa-solid fa-trash "></i> </a>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="{{asset('img/'. $item->slide)}}" width="200px" height="150px"></img>
                        </td>
                        <td>
                            <a class="btn btn-primary" href="{{url('update-image',$item->id)}}">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <hr>
                            <a class="btn btn-danger" onclick="confirmation(event)" href="{{url('delete-image',$item->id)}}" data-confirm-delete="true" method="post" class="d-inline">
    ...
    <script>
        ...
        function create() {
            $.get("{{route('create-image')}}", {}, function(data, status) {
                $("#page").html(data);
