...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav gradient-bg-color sidebar sidebar-dark accordion" id="accordionSidebar">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.dashboard.index')}}">


                <div class="logo-img sidebar-brand-text mx-3 invert-img">
            ...
            <li class="nav-item">
                ...
                <div style="background-color:none; ">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-warning py-2 collapse-inner">
                ...
                <div class="bg-primary">
                    ...
                    <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{route('productifity')}}"><strong>Productifity</strong></a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="d-flex justify-content-center">
                                <span class="mr-1 d-none d-lg-inline text-black-600 small "> {{ Auth::user()->role }}</span>
                            </div>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" style="color: black " href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <div class="btn-new"> <strong> {{ Auth::user()->name }} </strong>
                                        &nbsp;
