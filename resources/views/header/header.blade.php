        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="card-tools">
                    ...
                    <a href="{{route('trash-header')}}" class="btn btn-danger">Trash <i class="fa-solid fa-trash "></i> </a>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <hr>
                            <a class="btn btn-danger" href="{{url('delete-header',$item->id)}}" onclick="confirmation(event)" href="{{url('delete-header',$item->id)}}" data-confirm-delete="true" method="post" class="d-inline">
